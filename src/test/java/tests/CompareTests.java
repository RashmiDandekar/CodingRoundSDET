...
public class CompareTests extends BaseTests {
	...
	public void compareReleaseDate_country() throws InterruptedException {
		...
		logger.pass(
				"Country of origin for Pushpa movie is successfully retrieved from imdb site. Value:" + imdbCountry);
		...
		logger.pass(
				"Country of origin for Pushpa movie is successfully retrieved from Wikipedia. Value:" + wikiCountry);
